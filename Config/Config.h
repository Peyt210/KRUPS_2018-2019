...
#define DEBUG_IRIDIUM (false) //decides if status messages from iridium should be printed
...
#define MEASURE_READ (59) //size of all the bytes coming in form the sensors
